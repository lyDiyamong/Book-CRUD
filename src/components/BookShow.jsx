...
function BookShow({ book, onDelete, onEdit }) {
    ...
    // handle submit when finish editing
    ...
    const randomImages = `https://picsum.photos/seed/${book.id}/300/200`

    return (
        <div className=" bg-slate-300 max-h-[600px] h-full rounded-xl border border-black relative p-4">
            <div className="">
                <img src={randomImages} alt="random" className="rounded-lg"/>
            </div>
            <h2 className="font-mono text-3xl font-medium mt-2 capitalize">{content}</h2>
            <div className="actions absolute top-4 right-4 flex gap-1">
